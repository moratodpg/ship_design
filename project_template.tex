\documentclass[onecolumn,superscriptaddress,11pt,aps]{revtex4}
...
\affiliation{\texttt{miss.reynolds@student.uliege.be} (\texttt{sXXXXXX})}
\author{\small{\bf Mr Reynolds}}
\affiliation{\texttt{mr.reynolds@student.uliege.be} (\texttt{sYYYYYY})}
